...
public class ModelPartController implements Controller<ModelPartOptions> {
    ...
    public ModelPartController(Option<ModelPartOptions> option) {
        this.option = option;
        o_render = CrystalChams.createBooleanOption(Component.translatable("config.option.renderFrames"),
        ...
        o_offset = EvilOption.<Float>createBuilder().name(Component.translatable("config.option.verticalOffset")).controller(floatOption -> FloatSliderControllerBuilder.create(floatOption).range(-2.5f, 2.5f).step(0.1f).formatValue(CrystalChams.BLOCKS_FORMATTER)).stateManager(StateManager.createSimple(0F, () -> option.binding().getValue().offset, newVal -> option.binding().getValue().offset = newVal)).group(OptionGroups.VERTICAL_OFFSET).build();
        o_rotationSpeed = EvilOption.<Float>createBuilder().name(Component.translatable("config.option.rotationSpeed")).controller(floatOption -> FloatSliderControllerBuilder.create(floatOption).range(-15f, 15f).step(0.1f).formatValue(val -> Component.translatable(String.format("%.1f", val) + "x"))).stateManager(StateManager.createSimple(1F, () -> option.binding().getValue().rotationSpeed, newVal -> option.binding().getValue().rotationSpeed = newVal)).group(OptionGroups.ROTATION_SPEED).build();
        o_bounceHeight = EvilOption.<Float>createBuilder().name(Component.translatable("config.option.bounceHeight")).controller(floatOption -> FloatSliderControllerBuilder.create(floatOption).range(0f, 2.5f).step(0.05f).formatValue(val -> Component.translatable(String.format("%.2f", val) + "x"))).stateManager(StateManager.createSimple(1F, () -> option.binding().getValue().bounceHeight, newVal -> option.binding().getValue().bounceHeight = newVal)).group(OptionGroups.BOUNCE_HEIGHT).build();
        o_bounceSpeed = EvilOption.<Float>createBuilder().name(Component.translatable("config.option.bounceSpeed")).controller(floatOption -> FloatSliderControllerBuilder.create(floatOption).range(0f, 2.5f).step(0.05f).formatValue(val -> Component.translatable(String.format("%.2f", val) + "x"))).stateManager(StateManager.createSimple(1F, () -> option.binding().getValue().bounceSpeed, newVal -> option.binding().getValue().bounceSpeed = newVal)).group(OptionGroups.BOUNCE_SPEED).build();
        o_delay = EvilOption.<Float>createBuilder().name(Component.translatable("config.option.delay")).controller(floatOption -> FloatSliderControllerBuilder.create(floatOption).range(-2.5f, 2.5f).step(0.1f).formatValue(CrystalChams.SECONDS_FORMATTER)).stateManager(StateManager.createSimple(0F, () -> option.binding().getValue().delay, newVal -> option.binding().getValue().delay = newVal)).group(OptionGroups.DELAY).build();
        o_scale = EvilOption.<Float>createBuilder().name(Component.translatable("config.option.scale")).controller(floatOption -> FloatSliderControllerBuilder.create(floatOption).range(0f, 2f).step(0.05f).formatValue(val -> Component.translatable(String.format("%.2f", val) + "x"))).stateManager(StateManager.createSimple(1F, () -> option.binding().getValue().scale, newVal -> option.binding().getValue().scale = newVal)).group(OptionGroups.SCALE).build();
        o_color = EvilOption.<Color>createBuilder().name(Component.translatable("config.group.color")).controller(ColorControllerBuilderImpl::new).stateManager(StateManager.createSimple(new Color(255, 255, 255), () -> option.binding().getValue().color, newVal -> option.binding().getValue().color = newVal)).group(OptionGroups.COLOR).build();
        o_alpha = EvilOption.<Float>createBuilder().name(Component.translatable("config.option.opacity")).controller(floatOption -> FloatSliderControllerBuilder.create(floatOption).range(0f, 1f).step(0.01f).formatValue(val -> Component.translatable(String.format("%.0f", val * 100) + "%"))).stateManager(StateManager.createSimple(1F, () -> option.binding().getValue().alpha, newVal -> option.binding().getValue().alpha = newVal)).group(OptionGroups.OPACITY).build();
        ...
        o_rainbowBrightness = CrystalChams.createFloatOptionPercent(Component.translatable(CrystalChams.SEPARATOR).append(Component.translatable("config.option.rainbowBrightness")), StateManager.createSimple(1F, () -> option.binding().getValue().rainbowBrightness, newVal -> option.binding().getValue().rainbowBrightness = newVal), OptionGroups.RAINBOW_BRIGHTNESS);
        o_animation = CrystalChams.createBooleanOption(Component.translatable("Animations"),
    ...
    public Component formatValue() {
        return Component.translatable("Edit");
    }
    ...
    public AbstractWidget provideWidget(YACLScreen screen, Dimension<Integer> widgetDimension) {
        subScreen = YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        //TODO include index?
                        .name(Component.translatable("Edit Frame"))
                        .option(o_render)
...
//                                .build())
    ...
    public static class ModelPartOptionElement extends ControllerWidget<ModelPartController> {
        ...
        public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
            ...
            Component name = Component.translatable("Frame " + (index + 1));
