...
//    public EvilOption<Easings> verticalOffsetEasing;
    ...
    public ModelPartController(Option<ModelPartOptions> option) {
        ...
        o_render = EvilOption.<Boolean>createBuilder().name(Text.of("Render Frame 1")).controller(CustomTickBoxControllerBuilder::new).stateManager(StateManager.createSimple(true, () -> option.binding().getValue().render, newVal -> option.binding().getValue().render = newVal)).build();
        ...
        o_bounceHeight = EvilOption.<Float>createBuilder().name(Text.of("Bounce Height")).controller(floatOption -> CustomFloatSliderControllerBuilder.create(floatOption).range(0f, 2f).step(0.05f).formatValue(val -> Text.of(String.format("%.2f", val) + "x"))).stateManager(StateManager.createSimple(1F, () -> option.binding().getValue().bounceHeight, newVal -> option.binding().getValue().bounceHeight = newVal)).build();
        o_bounceSpeed = EvilOption.<Float>createBuilder().name(Text.of("Bounce Speed")).controller(floatOption -> CustomFloatSliderControllerBuilder.create(floatOption).range(0f, 2f).step(0.05f).formatValue(val -> Text.of(String.format("%.2f", val) + "x"))).stateManager(StateManager.createSimple(1F, () -> option.binding().getValue().bounceSpeed, newVal -> option.binding().getValue().bounceSpeed = newVal)).build();
        ...
        o_culling = EvilOption.<Boolean>createBuilder().name(Text.of("Culled")).controller(CustomTickBoxControllerBuilder::new).stateManager(StateManager.createSimple(false, () -> option.binding().getValue().culling, newVal -> option.binding().getValue().culling = newVal)).build();
        o_funnyOption = EvilOption.<Boolean>createBuilder().name(Text.of("Funny Option")).controller(CustomTickBoxControllerBuilder::new).stateManager(StateManager.createSimple(false, () -> option.binding().getValue().funnyOption, newVal -> option.binding().getValue().funnyOption = newVal)).build();
        o_rainbow = EvilOption.<Boolean>createBuilder().name(Text.of("Rainbow")).controller(CustomTickBoxControllerBuilder::new).stateManager(StateManager.createSimple(false, () -> option.binding().getValue().rainbow, newVal -> option.binding().getValue().rainbow = newVal)).build();
