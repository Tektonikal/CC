...
public class ModelPartOptions {
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(renderLayer);
        ...
        result = 31 * result + Objects.hashCode(verticalOffsetEasing);
        ...
        result = 31 * result + Objects.hashCode(rotationSpeedEasing);
        ...
        result = 31 * result + Objects.hashCode(bounceHeightEasing);
        ...
        result = 31 * result + Objects.hashCode(bounceSpeedEasing);
        ...
        result = 31 * result + Objects.hashCode(tickDelayEasing);
        ...
        result = 31 * result + Objects.hashCode(scaleEasing);
        ...
        result = 31 * result + Objects.hashCode(alphaEasing);
        ...
        result = 31 * result + Objects.hashCode(rainbowSpeedEasing);
        ...
        result = 31 * result + Objects.hashCode(rainbowDelayEasing);
        ...
        result = 31 * result + Objects.hashCode(rainbowSaturationEasing);
        ...
        result = 31 * result + Objects.hashCode(rainbowBrightnessEasing);
