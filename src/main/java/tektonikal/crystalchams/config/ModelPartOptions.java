...
public class ModelPartOptions {
    ...
    public int hashCode() {
        ...
        result = 31 * result + Float.hashCode(delay);
        ...
        result = 31 * result + Float.hashCode(rainbowDelay);
