...
import static tektonikal.crystalchams.CrystalChams.hoveredIndex;
...
public class EvilYACLScreen extends YACLScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (this.tabManager.getCurrentTab() != null) {
            drawPreviewCrystal(context, ((tektonikal.crystalchams.mixin.yacl.CategoryTabAccessor) this.tabManager.getCurrentTab()).rightPaneDim(), this);
        }
        context.disableScissor();
