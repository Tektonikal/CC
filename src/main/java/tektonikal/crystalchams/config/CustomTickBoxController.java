...
//                graphics.fill(outlineX1 + 3, outlineY1 + 3, outlineX2 - 1, outlineY2 - 1, enabledState >= 0.5F ? ColorHelper.lerp(enabledState, 0x00000000, shadowColor) : 0x00000000);
//                graphics.fill(outlineX1 + 2, outlineY1 + 2, outlineX2 - 2, outlineY2 - 2, ColorHelper.lerp(enabledState, 0x00000000, color));
//            }
//            else{
