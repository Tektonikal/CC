...
public class EvilOption<T> implements Option<T> {
    ...
    public static class EvilOptionBuilder<T> implements Builder<T> {
        ...
        @Override
        public EvilOptionBuilder<T> description(@NotNull OptionDescription description) {
        ...
        @Override
        public EvilOptionBuilder<T> controller(@NotNull Function<Option<T>, ControllerBuilder<T>> controllerBuilder) {
        ...
        @Override
        public EvilOptionBuilder<T> customController(@NotNull Function<Option<T>, Controller<T>> control) {
        ...
        @Override
        public EvilOptionBuilder<T> stateManager(@NotNull StateManager<T> stateManager) {
        ...
        @Override
        public EvilOptionBuilder<T> binding(@NotNull Binding<T> binding) {
        ...
        @Override
        public EvilOptionBuilder<T> binding(@NotNull T def, @NotNull Supplier<@NotNull T> getter, @NotNull Consumer<@NotNull T> setter) {
        ...
        @Override
        public EvilOptionBuilder<T> available(boolean available) {
            this.available = available;
            return this;
        }

        @Override
        public EvilOptionBuilder<T> flag(@NotNull OptionFlag... flag) {
        ...
        @Override
        public EvilOptionBuilder<T> flags(@NotNull Collection<? extends OptionFlag> flags) {
        ...
        @Override
        @Deprecated
        public EvilOptionBuilder<T> instant(boolean instant) {
        ...
        @Override
        public EvilOptionBuilder<T> addListener(@NotNull OptionEventListener<T> listener) {
        ...
        @Override
        public EvilOptionBuilder<T> addListeners(@NotNull Collection<@NotNull OptionEventListener<T>> optionEventListeners) {
        ...
        @Override
        public EvilOptionBuilder<T> listener(@NotNull BiConsumer<Option<T>, T> listener) {
            Validate.notNull(listener, "`listener` must not be null");
        ...
        @Override
        public EvilOptionBuilder<T> listeners(@NotNull Collection<BiConsumer<Option<T>, T>> listeners) {
